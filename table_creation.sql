...
-- For the rule table
CREATE TABLE rule_files (name TEXT NOT NULL PRIMARY KEY, location TEXT NOT NULL, month INTEGER NOT NULL, year INTEGER NOT NULL, rules TEXT NOT NULL, csv NOT NULL);
