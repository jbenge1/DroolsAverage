...
//		http.authorizeRequests().antMatchers("/load").access("hasRole('ROLE_ADMIN')")
//		.antMatchers("/").access("hasRole('ROLE_USER', 'ROLE_ADMIN')")
//		.and().formLogin();		
...
//		http.authorizeRequests().antMatchers("/load").hasAnyAuthority("ADMIN");
	}
